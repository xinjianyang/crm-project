    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" id="addForm" action="/customer/edit">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="business">
                                ...
                                <c:forEach var="bus" items="${businesses}">
                                    <option value="${bus}" ${customer.business == bus ? 'selected' : ''}>${bus}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="source" class="form-control">
                                <option value=""></option>
                                <c:forEach items="${sourceses}" var="source">
                        ...
                        <div class="form-group">
                            ...
                            <select name="mark" class="form-control">
                                <option value=""></option>
                                <<option ${customer.mark == '★' ? 'selected' : ''} value="★" >★</option>
                                <option ${customer.mark == '★★' ? 'selected' : ''} value="★★" >★★</option>
                                <option ${customer.mark == '★★★' ? 'selected' : ''} value="★★★">★★★</option>
                                <option ${customer.mark == '★★★★' ? 'selected' : ''} value="★★★★">★★★★</option>
                                <option ${customer.mark == '★★★★★' ? 'selected' : ''} value="★★★★★">★★★★★</option>
                        ...
                        <div class="form-group">
                            <label>备注</label>
                            <input type="text" class="form-control" name="reminder" value="${customer.reminder}">
                        </div>
                    </form>
                </div>
