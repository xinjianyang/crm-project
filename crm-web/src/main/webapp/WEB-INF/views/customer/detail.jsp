        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a href="/mycustomer" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回列表</a>
                        <a href="/customer/edit/${customer.id}" class="btn bg-purple btn-sm"><i class="fa fa-pencil"></i> 编辑</a>
                        <button id="changeToOther" class="btn bg-orange btn-sm"><i class="fa fa-exchange"></i> 转交他人</button>
